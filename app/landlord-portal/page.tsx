...
type Overview = {
  properties: { id: string; label: string; city?: string; type?: string; bedrooms?: string; rent?: string; occupancy?: string; availableFrom?: string }[];
  listings: { id: string; title: string; location: string; price: number; status: string; availability: string; images: string[] }[];
  applications: { id: string; fullName: string; propertyAddress: string; rent: string; leaseTerm: string; status: string; submittedAt: string | null }[];
  maintenance: { id: string; fullName: string; propertyAddress: string; issueDescription: string; status: string; submittedAt: string | null }[];
