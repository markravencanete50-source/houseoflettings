...
async function generateValuationPdf(data: ValuationLeadData): Promise<Uint8Array> {
  ...
  page.drawText(`Range: ${fmtGBP(data.low)}${data.period} — ${fmtGBP(data.high)}${data.period}`, {
