...
export const MATRIX_SECTIONS: MatrixSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['Emergency Maintenance Support', 0, 0, 0, 0, 1],
      ...
      ['Check In & Check Out Inventory', 0, 0, 0, 1, 1],
  ...
  },
  {
    ...
    rows: [
      ...
      ['Property Inspections with Report', 0, 0, 0, 0, 1],
      ['Routine Inspection Every 6 Months', 0, 0, 0, 0, 1],
    ],
  },
];
