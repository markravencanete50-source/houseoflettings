...
<div style="max-width:640px;margin:32px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.08);">
  ...
  <div style="padding:34px 40px;">
    ...
    <div style="background:#f8f9ff;border-radius:12px;padding:18px 22px;">
      ...
      <div style="font-size:14px;color:#111827;padding:6px 0;"><span style="color:#6b7280;">Signed by:</span> <strong>${data.signatureName || data.fullName}</strong>${data.jointLandlord && data.signature2Name ? ` and <strong>${data.signature2Name}</strong>` : ''} on ${data.signatureDate}</div>
