...
export default function PropertyForm({
  ...
  // Landlord assignment is NOT done here — posting/editing a listing is purely
  // the public advert. The property's landlordId is preserved as-is; assigning
  // it to a landlord's portal is a separate feature in the Manage portal.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data: Omit<Property, 'id' | 'createdAt'> = {
        ...
        // Preserve the existing owner; assignment happens in the Manage portal.
        landlordId: existing?.landlordId ?? landlordId ?? '',
        landlordName: (existing as any)?.landlordName ?? landlordName ?? '',
        status: 'active',
        propertyType,
