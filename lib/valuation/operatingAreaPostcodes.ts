...
const sDistricts: Record<string, DistrictInfo> = {
  ...
  S5:  { area: 'Sheffield', subArea: 'Southey / Parson Cross', tier: 'sheffield_inner', region: 'yorkshire' },
  S6:  { area: 'Sheffield', subArea: 'Hillsborough / Walkley', tier: 'sheffield_inner', region: 'yorkshire' },
  S7:  { area: 'Sheffield', subArea: 'Nether Edge / Sharrow',  tier: 'sheffield_inner', region: 'yorkshire' },
  S8:  { area: 'Sheffield', subArea: 'Woodseats / Norton',     tier: 'sheffield_inner', region: 'yorkshire' },
  S9:  { area: 'Sheffield', subArea: 'Tinsley / Attercliffe',  tier: 'sheffield_inner', region: 'yorkshire' },
  S10: { area: 'Sheffield', subArea: 'Broomhill / Crookes',    tier: 'sheffield_inner', region: 'yorkshire' },
  S11: { area: 'Sheffield', subArea: 'Ecclesall / Broomhill',  tier: 'sheffield_inner', region: 'yorkshire' },
